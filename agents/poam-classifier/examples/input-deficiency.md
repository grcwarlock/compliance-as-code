...
- **Compensating controls in effect during the window:**
  - Inline Segregation of Duties enforced at role assignment (toxic combinations blocked).
  - All new GL access during the period required ITSM ticket with documented approval (provisioning control operated effectively).
  - SIEM correlation rules monitoring privileged action patterns ran throughout.
- **Pervasiveness:** isolated to the GL service. Other financial systems (sub-ledgers, AP, AR) had reviews completed on schedule.
